#!/usr/bin/env bash
# Brings up unitree_bridge (launch/unitree_bridge.launch in the unitree_bridge package):
# cmd_vel -> Unitree Go2 SDK.
# Meant to be run by systemd/unitree_bridge.service, not sourced or run interactively.
set -e
...
exec roslaunch unitree_bridge unitree_bridge.launch
